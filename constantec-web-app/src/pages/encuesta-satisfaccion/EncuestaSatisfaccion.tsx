...
export const EncuestaSatisfaccion = () => {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useGetEncuestaEstatus(id_estudiante)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorForm(
        error?.response?.data?.detail || 'Error al enviar la encuesta'
      )
      setStatus('error')
    }
  }
        ...
        {yaRespondio ? (
          ...
          >
            ...
            <Flex gap="5" mt="5" mb="5" justify="center">
              {[1, 2, 3, 4, 5].map((num) => (
                ...
                >
                  ...
                  />
                  <Text size="3" weight={valor === num ? 'bold' : 'regular'}>
                    {num}
                  </Text>
                </label>
              ))}
            ...
            <Box mt="4">
              <Button
                type="submit"
                disabled={valor === null || enviado || status === 'loading'}
              >
